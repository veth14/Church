    ...
    <section id="services" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our Services & Programs</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            We offer a variety of services and programs designed to help you grow in your faith 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="bg-gray-50 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-secondary-600 font-semibold mb-3">{service.time}</p>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600 mb-6">
            New to our church? We'd love to meet you and help you get connected.
          </p>
